export const defaultHtml = `
  ...
  <head>
    ...
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@700&family=Fira+Mono:wght@400;700&family=Open+Sans:wght@400;600&display=swap" rel="stylesheet">
    ...
    <style>
      ...
      .section { background: #fff; border-radius: 1rem; box-shadow: 0 2px 8px #0001; margin-bottom: 2rem; padding: 2rem; }
      .problem-title { display: flex; align-items: center; font-size: 1.25rem; font-weight: 700; color: #2563eb; margin-bottom: 0.5rem; }
      .problem-title i { margin-right: 0.5rem; }
      .tip { background: #e0f2fe; color: #0369a1; border-left: 4px solid #0ea5e9; padding: 1rem; border-radius: 0.5rem; margin-top: 2rem; }
